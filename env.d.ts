declare module '@env' {
  export const MEDIA_API_URL:string
  export const STRAPI_TOKEN: string
  export const TECH_IN_AFRICA:string
  ...
  export const STRAPI_OPPORTUNITIES_URL:string
  ...
  export const APPWRITE_NOTIFICATION_TOKEN_COLLECTION_ID: string
}